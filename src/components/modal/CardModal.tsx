...
export const CardModal = () => {
    ...
    return (
        <div>
            ...
            <Button
                onClick={open}
                className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hover:opacity-100 opacity-90">
                Ver
            </Button>
                                ...
                                <div className="max-w-2xl mx-auto ">
                                    <div className="bg-white shadow-md border border-gray-200 rounded-lg sm:p-6 lg:p-8 dark:bg-white-100 dark:border-gray-700">
                                        <div className='flex justify-between'>
                                            <Button
                                                className="text-gray-400 dark:text-white opacity-80 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                                                onClick={close}
                                        ...
                                        <div className="space-y-6 p-10"  >
                                            <Card className="overflow-hidden rounded-2xl p-5 shadow-lg">
                                                ...
                                                />
                                                <h3 className="text-xl font-semibold text-blue-900 mb-2">Toyota Corolla</h3>
                                                ...
                                                <p className="text-blue-700 font-medium">R$ 150,00/dia</p>
                                                <p className="text-gray-600 text-sl">Marca: Toyota</p>
                                                <p className="text-gray-600 text-sl">Placa: ABC-1234</p>
                                                <p className="text-gray-600text-sl mb-4">Ano: 2023</p>
                                                <Button onClick={handleError} className="mt-4 w-full bg-blue-600 hover:bg-blue-700 opacity-80 hover:opacity-100 text-white font-bold py-2 px-4 rounded">
                                                    Alugar
                                                </Button>
